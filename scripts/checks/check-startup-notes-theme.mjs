...
try{
 ...
 console.log('PASS: navigation visible throughout startup; no splash or startup stages; module search/chips/FAB match all 8 season/night palettes.');
